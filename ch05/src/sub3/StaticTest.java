 ...
 * 2025/07/14
 * 설유진
 * static 변수(클래스변수), static 메서드(클래스메서드) 실습하기
 * 
 * 
 * 클래스 변수(정적변수). 클래스메서드(정적 메서드)
...
public class StaticTest {
	...
	public static void main(String[] args) {
		...
		/* 싱글톤 실습
		 * - 싱글톤 객체는 static 을 활용한 객체로 오직 하나의 인스턴스만 메모리상(Method area)에 존재
		 * - 싱글톤 객체를 사용해서 메모리 절약과 성능과 향상을 기대
		 * - 외부 생성을 막기 위해 private 생성과 선언
		 * 
		 */
...
//		
		...
		System.out.println("1*2=" + c1.multi(1,2));
		System.out.println("1/2=" + c1.div(1,2));
